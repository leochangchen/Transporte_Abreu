...
import manejo.ManejoTransporte;
 ...
 */
public class MantenimientoTransporte extends javax.swing.JDialog {

    private Connection con = BdConection.getBdConection().getConexion();
    ManejoTransporte mTransporte = new ManejoTransporte();
    int codTransporte = 0;
    int total = mTransporte.getTotal();

    /**
     * Creates new form MantenimientoCliente
     */
    public MantenimientoTransporte(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        jLBCliente.setText("Introduzca el codigo de para buscar");
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addComponent(jTextPlaca, javax.swing.GroupLayout.DEFAULT_SIZE, 366, Short.MAX_VALUE)
    ...
    private void jBBuscarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBBuscarActionPerformed
        ...
        if (jTextBCodigo.getText().equals("")) {
            javax.swing.JOptionPane.showMessageDialog(null, "Introduzca el codigo de ncf para poder buscar");
        } else {

            Transporte transporte = mTransporte.getTransporte(Integer.parseInt(jTextBCodigo.getText()));
            codTransporte = transporte.getCodigo();
            System.out.println(codTransporte);
            buscar(transporte);
        }
    ...
    private void jBSiguienteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBSiguienteActionPerformed
        ...
        if (codTransporte < total) {
            codTransporte = codTransporte + 1;
            System.out.println(codTransporte);
            Transporte transporte = mTransporte.getTransporte(codTransporte);
            buscar(transporte);
        } else {
            javax.swing.JOptionPane.showMessageDialog(null, "Este es el ultimo transporte en el registro");
        }
    ...
    private void jBAnteriorActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBAnteriorActionPerformed
        ...
        if (codTransporte > ((total - total) + 1)) {
            codTransporte = codTransporte - 1;
            System.out.println(codTransporte);
            Transporte transporte = mTransporte.getTransporte(codTransporte);
            buscar(transporte);
        } else {
            javax.swing.JOptionPane.showMessageDialog(null, "Este es el primer transporte en el registro");
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MantenimientoTransporte.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                MantenimientoTransporte dialog = new MantenimientoTransporte(new javax.swing.JFrame(), true);
    ...
    private void buscar(Transporte transporte) {

        jTextDescripcion.setText(transporte.getDescripcion());
        jTextPlaca.setText(transporte.getPlaca());
        jTextColor.setText(transporte.getColor());
